...
if __name__ == "__main__":
	...
	# print 'Before Update'
	# # print pf.x_coordinate
	# # print pf.y_coordinate
	# # print pf.angle
	# print pf.get_audio_next_instruction()
	# # print pf.node_info[pf.next_node]['x']
	# # print pf.node_info[pf.next_node]['y']
	# # for i in pf.instruction:
	# #   print i

	# for i in vst:
	# 	pf._PathFinder__update_visited_nodes(i) # __update_visited_nodes is not meant to be called, called for testing purposes for now
